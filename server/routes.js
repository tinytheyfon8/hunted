...
routes.get('/users', isLoggedIn, (req, res) => { //test route to retrieve all user data
  User.find().exec(function(err, users){
    res.send(users);
  });
});

routes.get('/games', isLoggedIn, (req, res) => { //test route to retrieve all game data
...
routes.post('/gameover', isLoggedIn, (req, res) => {
  var date = new Date();
